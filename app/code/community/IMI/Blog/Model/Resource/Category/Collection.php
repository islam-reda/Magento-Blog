 ...
 */
class IMI_Blog_Model_Resource_Category_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                array('store_table' => $this->getTable('imi_blog/category_store')),
    ...
    protected function _toOptionArray($valueField='entity_id', $labelField='name', $additional=array())
    {
        ...
        foreach ($this as $item) {
            if ($item->getId() == Mage::helper('imi_blog/category')->getRootCategoryId()) {
                continue;
            }
