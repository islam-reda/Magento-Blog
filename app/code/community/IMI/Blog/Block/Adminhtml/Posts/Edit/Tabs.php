 ...
 */
class IMI_Blog_Block_Adminhtml_Posts_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        $this->addTab(
            ...
            array(
                ...
                'content' => $this->getLayout()->createBlock(
                    'imi_blog/adminhtml_posts_edit_tab_form'
                )
                ->toHtml(),
            )
        );
        $this->addTab(
            'form_meta_posts',
            array(
                'label'   => Mage::helper('imi_blog')->__('Meta'),
                'title'   => Mage::helper('imi_blog')->__('Meta'),
                'content' => $this->getLayout()->createBlock(
                    'imi_blog/adminhtml_posts_edit_tab_meta'
                )
                ->toHtml(),
            )
        );
        ...
        $this->addTab(
            ...
            array(
                ...
                'content' => $this->getLayout()->createBlock(
                    'imi_blog/adminhtml_posts_edit_tab_commentsgrid'
                )->toHtml(),
            )
        );
        ...
        $this->addTab(
            'customers_tap',
            array(
                'label'   => Mage::helper('imi_blog')->__('Customers'),
                'title'   => Mage::helper('imi_blog')->__('Customers'),
                'content' => $this->getLayout()->createBlock(
                    'imi_blog/adminhtml_posts_edit_tab_customersgrid')
                    ->toHtml(),
            )
        );
        ...
        if (!Mage::app()->isSingleStoreMode()) {
            $this->addTab(
                ...
                array(
                    ...
                    'content' => $this->getLayout()->createBlock(
                        'imi_blog/adminhtml_posts_edit_tab_stores'
                    )
                    ->toHtml(),
                )
            );
