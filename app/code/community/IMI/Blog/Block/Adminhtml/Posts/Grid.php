 ...
 */
class IMI_Blog_Block_Adminhtml_Posts_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'admin_posted_by_id',
            array(
                'header' => Mage::helper('imi_blog')->__('Admin Posted by'),
                'index'  => 'posted_by_id',
                'type'=> 'text',
                'renderer'  => 'IMI_Blog_Block_Adminhtml_Posts_Renderer_Adminpostedby',
                'filter_condition_callback'=> array($this, '_adminpostedbyfilter'),
            )
        );
        $this->addColumn(
            'category_id',
            array(
                'header' => Mage::helper('imi_blog')->__('Category'),
                'index'  => 'category_id',
                'type'=> 'text',
                'renderer'  => 'IMI_Blog_Block_Adminhtml_Posts_Renderer_Categoryname'
            )
        );
        $this->addColumn(
            'url_key',
            array(
                'header' => Mage::helper('imi_blog')->__('URL key'),
                'index'  => 'url_key',
            )
        );
